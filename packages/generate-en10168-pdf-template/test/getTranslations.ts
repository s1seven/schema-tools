...
import { CertificateLanguages, EN10168CertificateTranslations, EN10168Translations } from '../src/types';
...
export const getI18N = (translations: EN10168Translations, languages: string[] = ['EN', 'DE']) => {
  translations = languages.reduce((acc, key) => {
    acc[key] = translations[key];
    return acc;
  }, {} as EN10168Translations);
  return new Translate<EN10168Translations, EN10168CertificateTranslations>(translations, languages);
};
