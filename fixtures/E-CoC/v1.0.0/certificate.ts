 ...
 */
export type NormativeRef = [string, ...string[]];
...
export interface ECoC {
  ...
  Declaration?: {
    ...
    Signature: {
      ...
      /**
       * refer to PartyNo in Party
       */
      PartyRefOfSigner: number;
...
export interface HigherDataLevel {
   ...
   */
  BusinessRef: {
    StandardReferences: [Reference, ...Reference[]];
...
export interface Object {
  ...
  /**
   * Links and references to underlying E-CoC
   */
  RefCoC?: {
    /**
  ...
  /**
   * referenced to party in party-Structure, PartyNo from Party object
   */
  PartyRefId: number;
  /**
   * reference to ObjectId of related item
   */
  ReferencedObjects?: [number, ...number[]];
  ObjectProperties: [
    {
      Name:
        | 'PartNo'
